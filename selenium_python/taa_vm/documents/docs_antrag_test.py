...
class DocsAntragTests(unittest.TestCase, CommonTasks):
    ...
    def test_docs_antrag_on_antrag(self):
        ...
        self.documents_popup_generate_document((u"Antrag", ))

        WebDriverWait(driver, 20).until_not(self.no_more_than_one_window_open)
