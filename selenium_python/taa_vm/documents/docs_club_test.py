...
class DocsClubTests(unittest.TestCase, CommonTasks):
    ...
    def test_docs_club_on_tarifdaten(self):
    ...
    def test_docs_club_on_antragsteller(self):
    ...
    def test_docs_club_on_zusatzdaten(self):
    ...
    def test_docs_club_on_antrag(self):
