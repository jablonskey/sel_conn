...
class DocsInvitatioTests(unittest.TestCase, CommonTasks):
    ...
    def test_docs_invitatio_on_antrag(self):
        ...
        self.documents_popup_generate_document((u"Invitatio", ))
        ...
        WebDriverWait(driver, 60).until(
            EC.text_to_be_present_in_element((By.XPATH, "(/html/body/div[1]/div[2]/div[4]/div/div[1]/div[2]/div[1])"),
                                             ...
                                             u"Anforderung eines verbindlichen"))
        driver.close()
